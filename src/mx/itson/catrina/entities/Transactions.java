...
public class Transactions implements Comparable<Transactions> {
    ...
    // Variables de instancia que representan información de la transacción
    private Date date; // Fecha de la transacción
    private String description; // Descripción de la transacción
    private float amount; // Monto de la transacción
    private TipoMovimiento type; // Tipo de movimiento (Depósito, Retiro, etc.)
    private String fechaOperacion; // Fecha de la operación
    private String descripcionOperacion; // Descripción detallada de la operación
    private float deposito; // Monto depositado
    private float retiro; // Monto retirado
    private float subtotal; // Subtotal de la transacción
