...
public class Account {
    ...
    private Customer customer; // Cliente asociado a la cuenta
    private List<Transactions> transactions; // Lista de transacciones de la cuenta
    private List<Transactions> transactionsOp; // Lista de transacciones pendientes de la cuenta
    ...
    /**
     * Obtiene la lista de transacciones pendientes de la cuenta.
     * @return Lista de transacciones pendientes de la cuenta.
     */
    ...
    /**
     * Establece la lista de transacciones pendientes de la cuenta.
     * @param transactionsOp Lista de transacciones pendientes a establecer.
     */
