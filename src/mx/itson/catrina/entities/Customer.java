...
public class Customer {
    ...
    // Variables de instancia que representan información del cliente
    private String id;
    private String name; // Nombre del cliente
    private String address; // Dirección del cliente
    private String city; // Ciudad del cliente
    private String rfc; // RFC (Registro Federal de Contribuyentes) del cliente
    private String zip_code; // Código postal del cliente
